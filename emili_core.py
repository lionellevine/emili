...
#            messages,full_transcript = add_message([new_message],[messages,full_transcript],gui_app)
        ...
        gui_app.chat_signal.new_message.emit(new_message) # Signal GUI to display the new chat
        messages,full_transcript = add_message([new_message],[messages,full_transcript],gui_app)
...
def add_message(new_messages, transcripts, gui_app): # append one or messages to one or more transcripts
    ...
    for msg in new_messages:
        ...
        for tr in transcripts:
            tr.append(msg)
    gui_app.chat_signal.update_transcript.emit(transcripts) # Signal GUI transcript tab to update
    return transcripts
